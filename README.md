...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-alembic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13526&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-alembic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-alembic` can be installed with:

```
conda install pytest-alembic
```

It is possible to list all of the versions of `pytest-alembic` available on your platform with:
